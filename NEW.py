...
while message:
    ...
    with open(f'{path}/Department.csv','a',newline='')as f:
        ...
        script.writerow(['CSE(IOT) & CSBS','Computer Sience and Engineering and Internet of Things and Business Studies'])
...
print('\n','Computer Sience and Engineering : CSE','\n',
      'Computer Sience and Engineering and Artificial Intelligence : CSE(AI)','\n',
      'Computer Sience and Engineering and Artificial Intelligence and Machine Learning : CSE(AIML)','\n',
      'Computer Sience and Engineering and Internet of Things and Business Studies : CSE(IOT) & CSBS','\n',
...
stud_no=int(input("Enter the no. of students whose data you want to input : "))
print('\n')
print('-'*50)
for i in range(stud_no):
    ...
    if duplicate('Student.csv',student_id,0):
        ...
        print('\n',"The subjects are [Python,Math,Physics,Chemistry,Biology,English]")
